namespace Zinnia.Action.Collection
{
    ...
    /// </summary>
    public class ActionObservableList : DefaultObservableList<Zinnia.Action.IAction, ActionObservableList.UnityEvent>
    {
        /// <summary>
        /// Defines the event with the <see cref="Zinnia.Action.Action"/>.
        /// </summary>
        [Serializable]
        public class UnityEvent : UnityEvent<Zinnia.Action.IAction> { }
    }
}